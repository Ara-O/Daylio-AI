<template>
    ...
    <div class=" bg-[#D3ECD0] h-32 animate-pulse duration-[20s] w-32 absolute bottom-12 z-0 rounded-full blur-3xl">
    </div>
    <main class="px-12 text-center  bg-neutral-800 h-screen flex justify-center items-center flex-col">
